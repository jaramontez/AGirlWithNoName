...
"""
    ...
    type_instructions = {
        ...
        "grant_or_funder": (
            "Using the scraped art_grants and grants data, identify ONE specific, real funding "
            "opportunity that Doodle Street can actually apply for RIGHT NOW as a first-year nonprofit. "
            "\n\nStrict criteria — the opportunity MUST meet ALL of these:"
            "\n- Open to nonprofits in year 1 or 2 (no '3 years of operation' requirement)"
            "\n- Not geographically restricted to states Doodle Street isn't in, OR is national"
            "\n- Has a real application process the founder can start this week"
            "\n- Is either in-kind (art supplies/products) OR cash grant OR corporate sponsorship"
            "\n\nPrioritize from the scraped art_grants list first. If a scraped source has "
            "real eligibility details, use them. Supplement with your knowledge of these "
            "types of opportunities that are often open to new orgs:"
            "\n- Corporate product donation programs (art supply companies, office supply retailers)"
            "\n- Micro-grant programs ($500-$5000): Pollination Project, Awesome Foundation, "
            "local community foundations, arts councils"
            "\n- In-kind donation programs: Dick Blick, Michaels, Utrecht, Sargent Art, Faber-Castell"
            "\n- Arts education grants: NAMTA Foundation, Americans for the Arts, state arts councils"
            "\n- Corporate community grants: Walmart Local Community Grants (rolling, up to $5K), "
            "Target Community Giving, Lowe's Toolbox for Education"
            "\n\nFormat your response with: Opportunity name, what they give, grant size/value, "
            "eligibility requirements (be specific — list what IS required), deadline or cycle, "
            "direct application URL, and a 3-sentence pitch Doodle Street should use in the application."
        ),
        "org_suggestion": (
